...
install_root = "/root/emotiphone/sinatra"
...
FileUtils.mkdir_p "/root/emotiphone/public_html/sinatra"

puts "installing symlink"
FileUtils.ln_s "#{install_root}/#{app_name}", "/root/emotiphone/public_html/sinatra/#{app_name}"

puts "giving you ownership"
FileUtils.chown_R "root", "users", "/root/emotiphone/sinatra"
FileUtils.chown_R "root", "users", "/root/emotiphone/public_html/sinatra"
